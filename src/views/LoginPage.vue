<template>
  <ion-page>
    ...
    <ion-content class="ion-padding">
      ...
      <ion-button expand="block" fill="clear" @click="router.push('/register')">Créer un compte</ion-button>
      <ion-button expand="block" fill="clear" @click="router.push('/forgot-password')">
        Mot de passe oublié ?
      </ion-button>
    </ion-content>
  </ion-page>
